...
then
    ...
    sudo chmod 000 /Library/PrivilegedHelperTools/com.alibaba.security.aliedrsrv
...
then
	echo "now bootstrap alisafe service..."
    sudo chmod 777 /usr/local/bin/alipro
    sudo chmod 777 /Library/PrivilegedHelperTools/com.alibaba.security.aliedrsrv
	...
	echo "通过命令行执行alisafe stop或alisafe start来关闭或打开监控"
fi
